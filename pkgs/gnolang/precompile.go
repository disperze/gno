...
const (
	gnoRealmPkgsPrefixBefore = "gno.tools/r/"
	gnoRealmPkgsPrefixAfter  = "gno.land/r/"
	gnoPackagePrefixBefore   = "gno.tools/p/demo/"
	gnoPackagePrefixAfter    = "gno.land/p/demo/"
	gnoStdPkgBefore          = "github.com/gnolang/gno/stdlibs/stdshim"
	gnoStdPkgAfter           = "std"
)
...
func RewriteAlias(f *ast.File, pkg, alias string) {
	for _, imp := range f.Imports {
		if getImportPath(imp) == pkg {
...
func getImportPath(s *ast.ImportSpec) string {
